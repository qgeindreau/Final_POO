...
chemin Auteur1 Auteur2" )
                ...
                if len(commande)==2:
                    ...
                    print(15)
                    try:
                        print(commu_I_Graph.influence(commande[2],profondeur=int(commande[3])))
                    except:
                        print('Commande mal rentrée \nExecutez sans paramètres pour plus de détails')
                ...
                if len(commande)==2:
                    ...
                    try:
                        print(commu_I_Graph.influenced(commande[2],int(commande[3])))
                    except:
                        print('Commande mal rentrée \nExecutez sans paramètres pour plus de détails')
                ...
                if len(commande)==2:
                    ...
                    try:
                        commu = commu_I_Graph.communaute(commande[2],int(commande[3]))
                        print(commu)
                    except:
                        print('Commande mal rentrée \nExecutez sans paramètres pour plus de détails')
